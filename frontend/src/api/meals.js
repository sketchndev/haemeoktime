...
export const getFrequentIngredients = () => client.get('/meals/frequent-ingredients')
export const addFrequentIngredient = (name) => client.post('/meals/frequent-ingredients', { name })
export const deleteFrequentIngredient = (id) => client.delete(`/meals/frequent-ingredients/${id}`)
